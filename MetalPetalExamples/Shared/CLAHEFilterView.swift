        ...
        ImageFilterView(filter: MTICLAHEFilter(),
                        ...
                        parameters: [
                            ...
                            FilterParameter(
                                ...
                                sliderRange: 4 ... 32,
                                step: 1,
                                updater: { filter, size in
                                    filter.tileGridSize = MTICLAHESize(width: Int(size), height: Int(size))
                                }
                            ),
                        ])
                        .noteOverlay(NoteView {
                            VStack(alignment: .leading, spacing: 6) {
                                Text(
                                    "This is an example of \"Contrast Limited Adaptive Histogram Equalization\" filter."
                                )
