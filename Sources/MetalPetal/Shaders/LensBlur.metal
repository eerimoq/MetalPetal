...
METAL_FUNC float4 sampleWithDelta(texture2d<float, access::sample> texture,
...
fragment HexagonalBokehBlurAlphaPassOutput
hexagonalBokehBlurAlpha(VertexOut vertexIn [[stage_in]],
                        texture2d<float, access::sample> colorTexture [[texture(0)]],
                        sampler colorSampler [[sampler(0)]],
...
fragment float4 hexagonalBokehBlurBravoCharlie(VertexOut vertexIn [[stage_in]],
                                               texture2d<float, access::sample> verticalTexture
                                               [[texture(0)]],
                                               sampler verticalSampler [[sampler(0)]],
                                               texture2d<float, access::sample> diagonalTexture
                                               [[texture(1)]],
                                               ...
                                               constant float &power [[buffer(2)]])
{
    ...
    float4 color =
        (sampleWithDelta(verticalTexture, verticalSampler, vertexIn.textureCoordinate, delta0 * coc) +
