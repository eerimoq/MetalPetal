...
fragment float4 highPassSkinSmoothingGBChannelOverlay(VertexOut vertexIn [[stage_in]],
    ...
    constant float &amount [[buffer(0)]])
{
    ...
    float4 bgChannelOverlayColor =
        bgChannelOverlayTexture.sample(bgChannelOverlayTextureSampler, vertexIn.textureCoordinate);
    float4 blurredBGChannelOverlayColor = blurredBGChannelOverlayTexture.sample(
        blurredBGChannelOverlayTextureSampler, vertexIn.textureCoordinate);
