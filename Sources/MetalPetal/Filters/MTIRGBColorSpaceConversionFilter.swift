...
public final class MTIAppleLogToLinearFilter: MTIUnaryImageRenderingFilter {
    override public static func fragmentFunctionDescriptor() -> MTIFunctionDescriptor {
...
public final class MTILinearToAppleLogFilter: MTIUnaryImageRenderingFilter {
    override public static func fragmentFunctionDescriptor() -> MTIFunctionDescriptor {
        MTIFunctionDescriptor(name: "convertLinearRGBToAppleLog")
    }
