...
func generateBlendingShaders(blendModes: [String]) -> [String: String] {
    var functions = ""
...
func generateMultilayerCompositeShaders(blendModes: [String]) -> [String: String] {
    var functions = ""
    for mode in blendModes {
...
func generateBlenders() -> [String: String] {
    let blendModes = [
        "Normal",
        "Darken",
        "Multiply",
